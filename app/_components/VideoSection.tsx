...
export default function VideoSection() {
  return <div className="w-screen relative">
    <Image className="background background--3" src="/bg-3.svg" width={1221} height={1221} alt="background" />
    ...
    <div className="w-11/12 xl:w-full max-w-[1320px] mx-auto my-20 lg:my-56 relative z-20">
      <header className="flex flex-col justify-center items-center">
        ...
        <h2 className="text-center font-extrabold text-4xl lg:text-6xl mt-4">
